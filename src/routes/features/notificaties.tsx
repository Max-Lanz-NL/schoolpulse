...
import { Bell, ArrowLeft, Smartphone, Settings, Clock } from "lucide-react";
import logo from "@/assets/schoolpulse-logo.png";

export const Route = createFileRoute("/features/notificaties")({
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto max-w-4xl px-6">
          <div className="grid gap-12 md:grid-cols-2">
              ...
              {[
                {
                  ...
                  desc: "Realtime alerts op telefoon en computer voor belangrijke events",
                },
                {
                  icon: Settings,
                  title: "Volledige controle",
                  desc: "Kies zelf welke notifications je wilt en hoe vaak je ze ontvangt",
                },
                {
                  icon: Clock,
                  title: "Smart timing",
                  desc: "Notificaties op het juiste moment — geen spam, geen missen",
                },
            ...
            <div className="rounded-2xl border border-border bg-card p-8">
              <h3 className="text-lg font-semibold">Notificaties voor</h3>
          ...
          <div className="mt-16 rounded-2xl border border-border bg-muted/40 p-8 text-center">
            <h3 className="text-xl font-semibold">Zorg dat niemand iets mist?</h3>
            <Link
              to="/app"
      ...
      <footer className="border-t border-border py-10 mt-20">
        <div className="mx-auto max-w-7xl px-6 text-center text-sm text-muted-foreground">
          <p>© 2025 Schoolpulse — Slimme notificaties</p>
        </div>
      </footer>
    </div>
  );
